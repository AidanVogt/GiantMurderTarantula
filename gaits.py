...
GAIT_SWIM_FORWARD = 11
GAIT_SWIM_BACKWARD = 12

GAIT_SEND_TO_HOME = 13
GAIT_SET_HOME = 14
...
gaits = {
    ...
    #     #### GROUP 1 LEGS 1, 3, 5 ####
    #     # up
    #     (ACTION_UP, ACTION_UP, ACTION_UP, ACTION_NONE, ACTION_NONE, ACTION_NONE),
        
    #     # swing phase - leg in air, grounded legs move back
    #     (ACTION_FORWARD, ACTION_FORWARD, ACTION_FORWARD, ACTION_NONE, ACTION_NONE, ACTION_NONE),
        
    #     # down
    #     (ACTION_DOWN, ACTION_DOWN, ACTION_DOWN, ACTION_NONE, ACTION_NONE, ACTION_NONE),
        
    #     (ACTION_BACKWARD, ACTION_BACKWARD, ACTION_BACKWARD, ACTION_BACKWARD, ACTION_BACKWARD, ACTION_BACKWARD),
        
    #     #### GROUP 2 LEGS 2, 4, 6 ####
    #     # up
    #     (ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_UP, ACTION_UP, ACTION_UP),
        
    #     # swing phase
    #     (ACTION_BACKWARD, ACTION_FORWARD, ACTION_BACKWARD, ACTION_FORWARD, ACTION_BACKWARD, ACTION_FORWARD),
        
    #     # down
    #     (ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_DOWN, ACTION_DOWN, ACTION_DOWN),
    # ],
    ...
    GAIT_SWIM_TURN_RIGHT: [
        ...
        (ACTION_FORWARD, ACTION_FORWARD, ACTION_FORWARD, ACTION_BACKWARD, ACTION_BACKWARD, ACTION_BACKWARD),
        
        (ACTION_DOWN, ACTION_DOWN, ACTION_DOWN, ACTION_DOWN, ACTION_DOWN, ACTION_DOWN),
        (ACTION_BACKWARD, ACTION_BACKWARD, ACTION_BACKWARD, ACTION_FORWARD, ACTION_FORWARD, ACTION_FORWARD),
    ...
    GAIT_COOL: [
        ...
        (ACTION_DOWN, ACTION_UP, ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_NONE),
        (ACTION_NONE, ACTION_DOWN, ACTION_UP, ACTION_NONE, ACTION_NONE, ACTION_NONE),
        (ACTION_NONE, ACTION_NONE, ACTION_DOWN, ACTION_UP, ACTION_NONE, ACTION_NONE),
        (ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_DOWN, ACTION_UP, ACTION_NONE),
        (ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_DOWN, ACTION_UP),
        (ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_NONE, ACTION_DOWN),
    ],
