...
def joystickLoop():
    ...
    while True:
        ...
        if controls is not None:
            ...
            x, y, a_btn, y_btn, b_btn, x_btn, left_joy = controls
            print(f"x: {x}, y: {y}, A: {a_btn}, Y: {y_btn}, B: {b_btn}, X: {x_btn}, Left Joy: {left_joy}")
            print()
            ...
            JoystickToGait(x, y, a_btn, x_btn, left_joy, bus)
